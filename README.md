...
- **[Customer Churn — Logistic Regression + XGBoost](./customer_churn_prediction/)** — Telco churn (LogReg vs XGBoost, CV tuning), PR-AUC/calibration, retention-threshold policies; XGBoost PR-AUC 0.67 Brier Score 0.13
