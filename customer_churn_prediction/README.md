...
| Logistic Regression (tuned) | 0.8494 | 0.6453 | 0.1354 | 0.752 | Similar/slightly worse than baseline |
| **XGBoost (tuned)** | **0.8562** | **0.6744** | **0.1321** | **0.773** | **Best overall performance** |
